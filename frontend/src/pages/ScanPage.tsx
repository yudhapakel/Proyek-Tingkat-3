...
export default function ScanPage({ auth, onLogout }: ScanPageProps) {
  ...
  return (
    <main className="dashboard-page">
      <section className="dashboard-hero">
        <div>
          <span className="dashboard-eyebrow">Fisight Scan</span>
          <h1>Halo, {auth.user.name}</h1>
          <p>Upload foto ikan, lihat hasil AI, dan cek riwayat analisis dari backend.</p>
        </div>
