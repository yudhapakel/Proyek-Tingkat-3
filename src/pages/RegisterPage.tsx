...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log('Register:', { username, email, password, remember })
  }
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="auth-form__submit" id="register-submit">
            Sign Up
          </button>
        </form>
        ...
        <div className="auth-card__social">
          <button className="auth-social-btn" id="register-google">
          ...
          <button className="auth-social-btn" id="register-apple">
